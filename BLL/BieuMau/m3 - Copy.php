<?php
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J10', (string)($count_Ths_hn));//số lượng Ths ở cơ sở hà nội
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L10', (string)($count_DH_hn));//số lượng Đại học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten`='Cao đẵng'";
  $result = mysql_query($sql);
  $count_CD_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M10', (string)($count_CD_hn));//số lượng Cao đẵng ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten` NOT IN ('Giáo sư','Phó giáo sư','TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẵng')";
  $result = mysql_query($sql);
  ...
  $sql = "SELECT * FROM qlnscongnghegtvt.lylich WHERE cosodaotao_id=1 AND year(ngayhopdonglamviec)=2016";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O10', (string)(mysql_num_rows($result)));


  //Nghỉ hưu 2016; Nam=60, Nữ=55
  $sql = "SELECT * from lylich where cosodaotao_id=1 AND ((gioitinh=1 AND year(date_add(ngaysinh, INTERVAL 60 YEAR))=2016) OR (gioitinh=0 AND year(date_add(ngaysinh, INTERVAL 55 YEAR))=2016))";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P10', (string)(mysql_num_rows($result)));


  //Thôi việc, chuyển công tác 2016
  $sql = "SELECT DISTINCT lylich.id FROM lylich, congtac WHERE lylich.cosodaotao_id=1 AND year(congtac.thoidiem_batdau)=2016 AND lylich.id=congtac.lylich_id";
  $result = mysql_query($sql);
...
//===========================End Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO HÀ NỘI===========================================
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J11', (string)($count_Ths_vp));//số lượng Ths ở cơ sở hà nội
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L11', (string)($count_DH_vp));//số lượng Đại học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten`='Cao đẵng'";
  $result = mysql_query($sql);
  $count_CD_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M11', (string)($count_CD_vp));//số lượng Cao đẵng ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten` NOT IN ('Giáo sư','Phó giáo sư','TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẵng')";
  $result = mysql_query($sql);
  ...
  //Tong hop dong nam 2016
  $sql = "SELECT * FROM qlnscongnghegtvt.lylich WHERE cosodaotao_id=2 AND year(ngayhopdonglamviec)=2016";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O11', (string)(mysql_num_rows($result)));

  //Nghỉ hưu 2016; Nam=60, Nữ=55
  $sql = "SELECT * from lylich where cosodaotao_id=2 AND ((gioitinh=1 AND year(date_add(ngaysinh, INTERVAL 60 YEAR))=2016) OR (gioitinh=0 AND year(date_add(ngaysinh, INTERVAL 55 YEAR))=2016))";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P11', (string)(mysql_num_rows($result)));


  //Thôi việc, chuyển công tác 2016
  $sql = "SELECT DISTINCT lylich.id FROM lylich, congtac WHERE lylich.cosodaotao_id=2 AND year(congtac.thoidiem_batdau)=2016 AND lylich.id=congtac.lylich_id";
  $result = mysql_query($sql);
...
//===========================End Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO VĨNH PHÚC===========================================
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J12', (string)($count_Ths_tn));//số lượng Ths ở cơ sở hà nội
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L12', (string)($count_DH_tn));//số lượng Đại học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten`='Cao đẵng'";
  $result = mysql_query($sql);
  $count_CD_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M12', (string)($count_CD_tn));//số lượng Cao đẵng ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten` NOT IN ('Giáo sư','Phó giáo sư','TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẵng')";
  $result = mysql_query($sql);
  ...
  //Tong hop dong nam 2016
  $sql = "SELECT * FROM qlnscongnghegtvt.lylich WHERE cosodaotao_id=3 AND year(ngayhopdonglamviec)=2016";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O12', (string)(mysql_num_rows($result)));

  //Nghỉ hưu 2016; Nam=60, Nữ=55
  $sql = "SELECT * from lylich where cosodaotao_id=3 AND ((gioitinh=1 AND year(date_add(ngaysinh, INTERVAL 60 YEAR))=2016) OR (gioitinh=0 AND year(date_add(ngaysinh, INTERVAL 55 YEAR))=2016))";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P12', (string)(mysql_num_rows($result)));


  //Thôi việc, chuyển công tác 2016
  $sql = "SELECT DISTINCT lylich.id FROM lylich, congtac WHERE lylich.cosodaotao_id=3 AND year(congtac.thoidiem_batdau)=2016 AND lylich.id=congtac.lylich_id";
  $result = mysql_query($sql);
...
//===========================End Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO THÁI NGUYÊN===========================================
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J13', (string)($count_Ths_hn+$count_Ths_vp+$count_Ths_tn));
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K13', (string)($count_DHCH_hn+$count_DHCH_vp+$count_DHCH_tn));
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L13', (string)($count_DH_hn+$count_DH_vp+$count_DH_tn));
  ...
  //Hợp đồng năm 2016
  $sql = "SELECT * FROM qlnscongnghegtvt.lylich WHERE (cosodaotao_id=1 OR cosodaotao_id=2 OR cosodaotao_id=3) AND year(ngayhopdonglamviec)=2016";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O13', (string)(mysql_num_rows($result)));


  //Nghỉ hưu 2016; Nam=60, Nữ=55
  $sql = "SELECT * from lylich where(gioitinh=1 AND year(date_add(ngaysinh, INTERVAL 60 YEAR))=2016) OR (gioitinh=0 AND year(date_add(ngaysinh, INTERVAL 55 YEAR))=2016)";
  $result = mysql_query($sql);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P13', (string)(mysql_num_rows($result)));


  //Thôi việc, chuyển công tác 2016
  $sql = "SELECT DISTINCT lylich.id FROM lylich, congtac WHERE year(congtac.thoidiem_batdau)=2016 AND lylich.id=congtac.lylich_id";
  $result = mysql_query($sql);
  ...
  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `gioitinh`=1 and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_nam_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C19', (string)($count_nam_hn));//số lượng nam ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `gioitinh`=0 and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_nu_hn = mysql_num_rows($result);
  ...
  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `chucdanhkhoahoc`='Giáo sư' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_GS_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F19', (string)($count_GS_hn));//số lượng Giáo Sư ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `chucdanhkhoahoc`='Phó giáo sư' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_PGS_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G19', (string)($count_PGS_hn));//số lượng phó Giáo Sư ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten`='TS' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_TS_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H19', (string)($count_TS_hn));//số lượng Tiến Sĩ ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten`='NCS' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_NCS_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I19', (string)($count_NCS_hn));//số lượng NCS ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten`='Ths' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_Ths_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J19', (string)($count_Ths_hn));//số lượng Ths ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten`='Đ. Học cao học' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_DHCH_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K19', (string)($count_DHCH_hn));//số lượng Đ. Học cao học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and (`hochamcaonhat_ten`='Cử nhân' or `hochamcaonhat_ten`='Kỹ sư') and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_DH_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L19', (string)($count_DH_hn));//số lượng Đại học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten`='Cao đẵng' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_CD_hn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M19', (string)($count_CD_hn));//số lượng Cao đẵng ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=1 and `hochamcaonhat_ten` NOT IN ('Giáo sư','Phó giáo sư','TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẵng') and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_Khac_hn = mysql_num_rows($result);
...
//===========================End Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO HÀ NỘI===========================================
  ...
  // ====================Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO VĨNH PHÚC==================================  
  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `gioitinh`=1 and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_nam_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C20', (string)($count_nam_vp));//số lượng nam ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `gioitinh`=0 and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_nu_vp = mysql_num_rows($result);
  ...
  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `chucdanhkhoahoc`='Giáo sư' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_GS_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F20', (string)($count_GS_vp));//số lượng Giáo Sư ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `chucdanhkhoahoc`='Phó giáo sư' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_PGS_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G20', (string)($count_PGS_vp));//số lượng phó Giáo Sư ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten`='TS' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_TS_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H20', (string)($count_TS_vp));//số lượng Tiến Sĩ ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten`='NCS' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_NCS_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I20', (string)($count_NCS_vp));//số lượng NCS ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten`='Ths' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_Ths_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J20', (string)($count_Ths_vp));//số lượng Ths ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten`='Đ. Học cao học' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_DHCH_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K20', (string)($count_DHCH_vp));//số lượng Đ. Học cao học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and (`hochamcaonhat_ten`='Cử nhân' or `hochamcaonhat_ten`='Kỹ sư') and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_DH_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L20', (string)($count_DH_vp));//số lượng Đại học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten`='Cao đẵng' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_CD_vp = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M20', (string)($count_CD_vp));//số lượng Cao đẵng ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=2 and `hochamcaonhat_ten` NOT IN ('Giáo sư','Phó giáo sư','TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẵng') and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_Khac_vp = mysql_num_rows($result);
...
//===========================End Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO VĨNH PHÚC===========================================
  ...
  // ====================Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO THÁI NGUYÊN==================================  
  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `gioitinh`=1 and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_nam_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C21', (string)($count_nam_tn));//số lượng nam ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `gioitinh`=0 and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_nu_tn = mysql_num_rows($result);
  ...
  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `chucdanhkhoahoc`='Giáo sư' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_GS_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F21', (string)($count_GS_tn));//số lượng Giáo Sư ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `chucdanhkhoahoc`='Phó giáo sư' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_PGS_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G21', (string)($count_PGS_tn));//số lượng phó Giáo Sư ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten`='TS' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_TS_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H21', (string)($count_TS_tn));//số lượng Tiến Sĩ ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten`='NCS' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_NCS_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I21', (string)($count_NCS_tn));//số lượng NCS ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten`='Ths' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_Ths_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J21', (string)($count_Ths_tn));//số lượng Ths ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten`='Đ. Học cao học' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_DHCH_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K21', (string)($count_DHCH_tn));//số lượng Đ. Học cao học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and (`hochamcaonhat_ten`='Cử nhân' or `hochamcaonhat_ten`='Kỹ sư') and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_DH_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L21', (string)($count_DH_tn));//số lượng Đại học ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten`='Cao đẵng' and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_CD_tn = mysql_num_rows($result);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M21', (string)($count_CD_tn));//số lượng Cao đẵng ở cơ sở hà nội

  $sql = "SELECT * FROM `lylich` where `cosodaotao_id`=3 and `hochamcaonhat_ten` NOT IN ('Giáo sư','Phó giáo sư','TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẵng') and ngachcongchuc_maso in ('15.113','15.111','15.112','15.110','13.090')";
  $result = mysql_query($sql);
  $count_Khac_tn = mysql_num_rows($result);
...
//===========================End Lay du lieu tu CSDL cho CƠ SỞ ĐÀO TẠO THÁI NGUYÊN===========================================
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J22', (string)($count_Ths_hn+$count_Ths_vp+$count_Ths_tn));
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K22', (string)($count_DHCH_hn+$count_DHCH_vp+$count_DHCH_tn));
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L22', (string)($count_DH_hn+$count_DH_vp+$count_DH_tn));
  ...
  $styleArray = array(
    ...
    $objWriter->save("../../file_export/bieu_mau/Mau m3.xlsx");
  }
  header("Location: ../../file_export/bieu_mau/Mau m3.xlsx");
?>
