<?php
  ...
  // Trình độ khác
  theo_coso('O10', "SELECT * FROM lylich where cosodaotao_id=1 AND chucdanhkhoahoc NOT IN ('Giáo sư','Phó giáo sư') AND hochamcaonhat_ten NOT IN ('TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẳng')");
  ...
  // Trình độ khác
  theo_coso('O11', "SELECT * FROM lylich where cosodaotao_id=2 AND chucdanhkhoahoc NOT IN ('Giáo sư','Phó giáo sư') AND hochamcaonhat_ten NOT IN ('TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẳng')");
  ...
  // Trình độ khác
  theo_coso('O86', "SELECT * FROM lylich where cosodaotao_id=3 AND chucdanhkhoahoc NOT IN ('Giáo sư','Phó giáo sư') AND hochamcaonhat_ten NOT IN ('TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẳng')");
  ...
  // Trình độ khác
  theo_coso('O12', "SELECT * FROM lylich WHERE tochuctructhuoc_id=4 AND chucdanhkhoahoc NOT IN ('Giáo sư','Phó giáo sư') AND hochamcaonhat_ten NOT IN ('TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẳng')");
  ...
  // Trình độ khác
  theo_coso('O87', "SELECT * FROM lylich WHERE tochuctructhuoc_id=11 AND chucdanhkhoahoc NOT IN ('Giáo sư','Phó giáo sư') AND hochamcaonhat_ten NOT IN ('TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẳng')");
 ...
 function column($col, $row, $sql) {
  ...
  function theo_phongban($row, $coso, $phongban) {
    ...
    // Trình độ khác
    column('O', $row, "SELECT * FROM lylich, khoaphongban where cosodaotao_id=$coso and chucdanhkhoahoc NOT IN ('Giáo sư','Phó giáo sư') AND hochamcaonhat_ten NOT IN ('TS','NCS','Ths','Đ. Học cao học','Cử nhân','Kỹ sư','Cao đẳng') AND khoaphongban.name='$phongban' AND lylich.khoaphongban_id=khoaphongban.khoaphongbanid");
  }
...
///// Tổ dạy lái xe
  // HN
  theo_phongban('93', 3, 'Tổ dạy lái xe');
...
///// Bộ Môn Lý Luận Chính Trị
  ...
  $styleArray = array(
    ...
    unlink("../../file_export/bieu_mau/Mau m6.html");
    $objWriter->save("../../file_export/bieu_mau/Mau m6.html");
  }
  header("Location: ../../file_export/bieu_mau/Mau m6.html");
?>
