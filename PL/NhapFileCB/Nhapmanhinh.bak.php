  ...
  <header class="art-header">
    ...
    <ul class="art-hmenu">
     <?php if($_SESSION['role']!=0){ ?>
       ...
       <li>
            <a href="temp.php" class="active" >Nhập lý lịch</a>
          <ul class="active">
                       <li><a href="temp.php">Nhập giao diện</a>
                <li><a href="../NhapFileCB/PLNhapFileCB.php" >Nhập file exel</a></li>
          </ul>
      </li>
      <li>
        ...
        <li><a href="">Báo cáo</a>
          ...
          <?php } else{ ?>
                <li>
            <a href="temp.php">Nhập lý lịch</a>
          <ul >
                         <li><a href="temp.php">Nhập giao diện</a>
                <li><a href="../NhapFileCB/PLNhapFileCB.php" >Nhập file exel</a></li>
          </ul>
		...
		//  if(isset($_SESSION['temp_id']))
		 ...
		 //H?p d?ng lao d?ng
		  ...
		  if($check_select==0) {
				...
				'$quanlynhanuoc','$phucapcv','$phucapkhac','$hokhauthuongtru','$loaituyendung','$ngaytd',
				'$loaihopdong','$chucdanhkhoahoc','$tinhoc','$vuotkhung','$coquantd','$ngaycapCMND','$noicapCMND','$ngaythamgiatc',
				'$noithamgiatc','$phucaptn','$phucapqs','$phucapgv','$chungchiNVSP','$noiTN','$_SESSION[admin_id]','0','$tinhns','$huyenns','$xans')";
		  }else
		  {
			
			  
			  $sql = "Update `qlnscongnghegtvt`.`lylich`  set  
				...
				`xuatthan`='$xuatthan', `nghetruoctuyendung`='$nghetruoctd', `ngaytuyendung`='$ngayhopdong', `coquanhientai_ngayvao`='$ngayvaocq',
				...
				`ngachcongchuc_ten`='$ngachcongchuc', `ngachcongchuc_maso`='$mangach', `ngachcongchuc_bacluong`='$bacluong', `ngachcongchuc_heso`='$hesoluong', 
				`ngachcongchuc_thang`='$thangluong',`ngachcongchuc_nam`='$namluong',
				...
				`quanlynhanuoc`='$quanlynhanuoc',`phucapchucvu`='$phucapcv',`phucapkhac`='$phucapkhac',`hokhauthuongtru`='$hokhauthuongtru',`loaihopdongtuyendung`='$loaituyendung',`ngayhopdonglamviec`='$ngaytd',
				`loaihopdonglamviec`='$loaihopdong',`chucdanhkhoahoc`='$chucdanhkhoahoc',`tinhoc_trinhdo`='$tinhoc',`vuotkhung`='$vuotkhung',`coquantuyendung`='$coquantd',`ngaycapcmt`='$ngaycapCMND',`noiCapcmt`='$noicapCMND',`ngaythamgiatc`='$ngaythamgiatc',
            ...
            <div class="art-postcontent art-postcontent-0 clearfix">
              <div class="art-content-layout">
                <div class="art-content-layout-row">
                  ...
                  <div id="menu" style="float:left;width:19%">
		 		<ul>
...
float: right">
          ...
          function createcb($table,$col1,$col2,$cmt,$selected=0){ // hàm tạo select
            ...
            echo '<select required name="'.$table.'" id="'.$table.'" style="margin-left:5px;">
		  ...
		  $check_select = $row_check[0];
            ...
            echo '<select required name="'.$table.'ns" id="'.$table.'ns" style="margin-left:5px;">
                    <option value="">-----'.$cmt.'----</option>';
            ...
            echo '<select name="'.$table.'" id='.$table.' style="width:24%;margin-left:5px;">';
		...
		/*	}*/
            ...
            echo '<select required   name="heso" id="heso" style="margin-left:5px;">';
                    echo'<option value="">chọn</option>';
					   if(isset($_SESSION['admin_id']))
						  {
									 $check = "Select taikhoan_id from lylich where taikhoan_id = '$_SESSION[admin_id]'";
		   ...
		   function createcb15($table,$col1,$col2,$cmt,$selected=0,$ten,$dk){ // hàm tạo select
            ...
            echo '<select name="'.$table.'" id="'.$table.'" style="margin-left:5px;">
                    <option value="">-----'.$cmt.'----</option>';
          ...
          if($cosodaotaoid=="2" && $_SESSION['role']==3 ){
			  ...
			  echo "<input name='cosodaotao' id='cosodaotao' value='CƠ SỞ ĐÀO TẠO VĨNH PHÚC' style='width:18%;margin-left:5px;'  />";
			  ...
			  createcb15("bomonto","bomontoid","name","MỜI CHỌN TỔ BỘ MÔN",$bomonto,'khoaphongbanid',$khoaphongban);
		       ...
		       echo "<input name='cosodaotao' id='cosodaotao' value='CƠ SỞ ĐÀO TẠO THÁI NGUYÊN' style='width:18%;margin-left:5px;'  />";
			  createcb3("tochuctructhuoc","tochuctructhuocid","name","MỜI CHỌN TỔ CHỨC TRỰC THUỘC",$tochuctructhuoc,'cosodaotaoid',$cosodaotaoid);
			   createcb15("khoaphongban","khoaphongbanid","name","MỜI CHỌN KHOA PHÒNG BAN",$khoaphongban,'tochuctructhuocid',$tochuctructhuoc);
			 createcb15("bomonto","bomontoid","name","MỜI CHỌN TỔ BỘ MÔN",$bomonto,'khoaphongbanid',$khoaphongban);
		  }
		      ...
		      echo "<input name='cosodaotao' id='cosodaotao' value='CƠ SỞ ĐÀO TẠO HÀ NỘI' style='width:18%;margin-left:5px;'  />";
			  createcb3("tochuctructhuoc","tochuctructhuocid","name","MỜI CHỌN TỔ CHỨC TRỰC THUỘC",$tochuctructhuoc,'cosodaotaoid',$cosodaotaoid);
			  createcb15("khoaphongban","khoaphongbanid","name","MỜI CHỌN KHOA PHÒNG BAN",$khoaphongban,'tochuctructhuocid',$tochuctructhuoc);
			  createcb15("bomonto","bomontoid","name","MỜI CHỌN TỔ BỘ MÔN",$bomonto,'khoaphongbanid',$khoaphongban);
		  }
                ...
                <fieldset>
                    ...
                    <table border="0" cellpadding="2" cellspacing="0" width="100%" >
                        <tbody><tr>
                            <td align="right" class="style6">
                                <div id="divImg" style="background-color: #66EEFF; width: 111px; height: 146px; border: 2px solid #CAD4E6;" onClick="javascript:UploadFile()">
                                    <img id="imgStd" alt="Quí vị nhấn vào đây để tải ảnh. Ảnh phải có đuôi là JPG và dung lượng không được quá 1 MB." style="background-color: #66EEFF; width: 111px; height: 146px" align="middle" src="../../images/avatar/<?php echo $avartar ?>">
                                </div>
                            </td>
                            <td>
                                <table >
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input name="txtNgaySinh" type="date"  maxlength="10" id="txtNgaySinh" value="<?php echo $ngaysinh; ?>" required style="width: 200px">
                                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="dienthoai" type="number" id="dienthoai" style="width:200px;" value="<?php  echo $dienthoai ; ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="chucvungay" type="date" id="chucvungay" value="<?php  echo $chucvungay ; ?>" style="width: 200px" />
                            </td>
                            <td align="center" width="5%">&nbsp;
                        ...
                        <tr>
                            <td colspan="3"  >
                                <label>Phụ cấp CV</label> <select name="phucapcv" id="phucapcv" style="width: 100px">
                                ...
                                <option <?php if($phucapcv=='0.2') echo "selected";  ?> value="0.2">0.2</option>
                                                         ...
                                                         Phụ cấp TN   <input name="phucaptn" value="<?php echo $phucaptn  ?>" type="text" id="phucaptn" style="width: 100px" />
</td>
                            ...
                            <tr> <td colspan="3">
                                ...
                                Phụ cấp QS   <input name="phucapqs" value="<?php echo $phucapqs  ?>" type="text" id="phucapqs" style="width: 100px" />
                                                                         Phụ cấp GV   <input name="phucapgv" value="<?php echo $phucapgv  ?>" type="text" id="phucapgv" style="width: 100px" />
                        ...
                        <tr>
                                                    <td colspan="3">
                                                          ...
                                                          Phụ cấp khác   <input name="phucapkhac" value="<?php echo $phucapkhac  ?>" type="text" id="phucapkhac" style="width: 100px" />
                                                          </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="DropDantoc" id="DropDantoc" type="text" style="height:23px;width:200px;" required>
	...
	<option <?php if($dantoc=='Tu Rí') echo "selected";  ?> value="Tu Rí">Tu Rí</option>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="DropTonGiao" id="DropTonGiao" type="text" style="height:23px;width:200px;" required>
	<option value="">-----Chọn----</option>
	...
	<option <?php if($tongiao=='Cao Đà') echo "selected";  ?> value="Cao Đà">Cao Đà</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <input required value="<?php echo $cmnd  ?>" name="txtCMND" type="number"  id="txtCMND" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                id="txtNgayCapCMND" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="DropXuatThan1" id="DropXuatThan1" type="text" onChange="javascript:showhideDivExpand(this,'divHCXTkhac','txtHCXTkhac');" style="height:23px;width:200px;" required>
	<option value="">-----Chọn----</option>
  ...
  <option <?php if($xuatthan=='Nông dân') echo "selected"; ?> value="Nông dân">Nông dân</option>
	...
	<option <?php if($xuatthan=='Hoàn cảnh khác') echo "selected"; ?> value="Hoàn cảnh khác">Hoàn cảnh khác</option>
                        ...
                        <tr>
                            <td align="right" class="style6">
                                Nhóm máu<b><font color="red">*</font></b>
                            </td>
                            <td>
                                <select name="dropNhomMau" id="dropNhomMau" type="text" style="height:23px;width:200px;" required>
	<option value="">-----Chọn----</option>
  <option <?php if($nhommau=='O') echo "selected"; ?>  value="O">O</option>
	...
	<option <?php if($nhommau=='AB') echo "selected"; ?>  value="AB">AB</option>
                        ...
                        <tr>
                            <td align="right" class="style6">
                                Tình trạng sức khỏe<b><font color="red">*</font></b>
                            </td>
                            <td>
                                <input value="<?php echo $suckhoe;  ?>" name="tbTinhTrangSK" type="text"  id="tbTinhTrangSK" style="width:200px;" required>
                        ...
                        <tr>
                            <td align="right" class="style6">
                                Chiều cao (m) <b><font color="red">*</font></b>
                            </td>
                            <td>
                                <input value="<?php echo $chieucao  ?>" name="tbCao" type="text"  id="tbCao" style="width:200px;" required>
                                <span id="RequiredFieldValidator24" style="color:Red;visibility:hidden;">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" class="style6">
                                Cân nặng (kg) <b><font color="red">*</font></b>
                            </td>
                            <td>
                                <input value="<?php echo $nang  ?>" name="tbNang" required type="text"  id="tbNang" style="width:200px;">
                            ...
                            <td>
                                <input name="ngayvaocq" value="<?php echo $ngayvaocq;  ?>" type="date"  id="ngayvaocq" style="width:200px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="ngaythamgiacm" value="<?php echo $ngaythamgiacm;  ?>" type="date"  id="ngaythamgiacm" style="width:200px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="ngayvaodang" value="<?php echo $ngayvaodang  ?>" type="date"  id="ngayvaodang" style="width:200px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="ngaychinhthuc" value="<?php echo $ngaychinhthuc;  ?>" type="date"  id="ngaychinhthuc" style="width:200px;">
                           ...
                           <tr>
                            ...
                            <td>
                                <input name="ngaythamgiatc" value="<?php echo $ngaythamgiatc;  ?>" type="date"  id="ngaythamgiatc" style="width:200px;">
            ...
            <fieldset>
                    <legend>Hợp đồng lao động :</legend>
                    <table border="0" cellpadding="2" cellspacing="0" width="100%">
                        <tbody>
                          <tr>
                            <td align="right" class="style6">
                            ...
                            <td>
                            <select name="loaituyendung" id="loaituyendung"  >
                              <option value="">-----Chọn----</option>
                             <option <?php if($loaituyendung=='Hợp đồng 1 năm') echo 'selected' ?> value="Hợp đồng 1 năm">Hợp đồng 1 năm</option>
                             <option <?php if($loaituyendung=='Hợp đồng 3 năm') echo 'selected' ?> value="Hợp đồng 3 năm">Hợp đồng 3 năm</option>
                             <option <?php if($loaituyendung=='HĐ không xác định thời hạn') echo 'selected' ?> value="HĐ không xác định thời hạn">HĐ không xác định thời hạn</option>  
                            </select>
                            </td>
                        </tr>
                          <tr>
                            <td align="right" class="style6">
                                Ngày kí hợp đồng lao động :
                            </td>
                            <td>
                                <input name="ngayhopdong" value="<?php echo $ngayhopdong; ?>" type="date" id="ngayhopdong" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                            <select name="loaihopdong" id="loaihopdong">
                                 <option value="">-----Chọn----</option>
                                 <option <?php if($loaihopdong=='Hợp đồng thử việc') echo 'selected' ?> value="Hợp đồng thử việc">Hợp đồng thử việc</option>
                                 <option <?php if($loaihopdong==='Hợp đồng 3 năm') echo 'selected' ?>   value="Hợp đồng 3 năm">Hợp đồng 3 năm</option>
                                 <option <?php if($loaihopdong==='HĐ không xác định thời hạn') echo 'selected' ?> value="HĐ không xác định thời hạn">HĐ không xác định thời hạn</option>  
                            </select>
                            </td>
                        </tr> 
                        <tr>
                            ...
                            <td>
                                <input name="ngaytd" value="<?php echo $ngaytd; ?>" type="date" id="ngaytd" style="width: 200px">
                            </td>
                        </tr>
            ...
            <fieldset>
                    ...
                    <table cellpadding="2" cellspacing="0" width="100%">
                        <tbody><tr>
                            ...
                            <td class="style9">
                                <input type="date" value="<?php echo $ngaynn ?>" name="ngaynn" id="ngaynn" style="width: 200px" />
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                               <input value="<?php echo $ngayxn ?>" type="date" name="ngayxn" id="ngayxn" style="width: 200px" />
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                                         <input type="number" value="<?php echo $namquanham ?>" name="namquanham" id="namquanham" style="width: 200px" />
            ...
            <fieldset>
                    ...
                    <table cellpadding="2" cellspacing="0" width="100%">
                        <tbody><tr>
                            ...
                            <td class="style9">
                                <select  name="lophocvan" id="lophocvan" style="width: 200px" >
                        ...
                        <tr>
                            ...
                            <td class="style9">
                                ...
                                <select required name="hocvi" id="hocvi" style="width: 200px" >
                                    <option value="">--Chọn--</option>
                                    <option <?php if($hocvi =="TSKH") echo "selected"; ?> value="TSKH">TSKH</option>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                              <input required value="<?php echo $namhocham ?>" type="number" name="namhocvi" id="namhocvi" style="width: 200px" />
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                               <input type="number" value="<?php echo $namdanhhieu ?>" name="namdanhhieu" id="namdanhhieu" style="width: 200px" />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="right" class="style6">
                                Lí luận chính trị  <b><font color="red">*</font></b>
                            </td>
                            <td class="style9">
                                 <select  name="caplyluan" id="caplyluan" required >
                                 <option value="">-----Chọn----</option>
                                    ...
                                    <option value="Sơ cấp và tương đương" <?php if($caplyluan=='Sơ cấp và tương đương') echo "selected"; ?>>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                                  <select  name="quanlynhanuoc" id="quanlynhanuoc" >
                                  <option value="">-----Chọn----</option>
                                    ...
                                    <option <?php if($quanlynhanuoc=='Chuyên viên chính trị') echo "selected"; ?> value="Chuyên viên chính trị">
                                     ...
                                     <option <?php if($quanlynhanuoc=='Cán sư') echo "selected"; ?> value="Cán sư">
                                      Cán sư
                                    </option>
                        ...
                        <tr>
                            ...
                            <td class="style9">
                                        <select  name="chucdanhkhoahoc" id="chucdanhkhoahoc" >
                                        <option value="">-----Chọn----</option>
                ...
                <div id="divMsg">
                    ...
                    <table cellpadding="2" cellspacing="0" width="100%" border="0">
                        <tbody><tr>
                            ...
                            <td>
							      <input name="hokhauthuongtru" type="text" id="hokhauthuongtru" value="<?php echo $hokhauthuongtru ?>" style="width: 300px" required>
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="UpdatePanel7">
                                  ...
                                  <input name="noiohiennay" type="text" value="<?php echo $noiohiennay ?>"   id="noiohiennay" style="width: 300px" required>
    ...
    <tr>
                            ...
                            <td class="style11">
                               <input name="namhuanchuong" value="<?php echo $namhuanchuong;?>" type="number" id="namhuanchuong" style="width: 200px">
                        ...
                        <tr>
                            ...
                            <td>
                                      <input name="namkyluatcaonhat" value="<?php echo $namkyluatcaonhat;?>" type="number" id="namkyluatcaonhat" style="width: 200px">
                ...
                <fieldset>
                    <legend>Ngạch công chức , viên chức</legend>
                    <table cellpadding="2" cellspacing="0" width="100%">
                        <tbody><tr>
                            <td align="left" colspan="3">
                        ...
                        <tr>
                            <td colspan='3' class="style10">
                                Ngạch <b><font color="red">*</font></b>
                         
                            <?php createcb4("ngach",'tenngach','name',$ngachcongchuc) ?>
                                   Mã ngạch <b><font color="red">*</font></b>

                                    <?php createcb5("ngach",'mangach','mangach','name',$mangach,'name',$ngachcongchuc) ?>        
                        ...
                        <tr>
                            <td colspan="3" >
                                    ...
                                    Bậc lương <b><font color="red">*</font></b> 
                                   <?php createcb10("bac_heso",'bac','bac','name',$bacluong,'mangach',$mangach) ?>
                                    Hệ số <b><font color="red">*</font></b> 
                                       <?php createcb6("bac_heso",'heso','heso',$hesoluong,'mangach',$mangach,'bac',$bacluong) ?>
                        ...
                        <tr>
                            <td colspan="3" >
                                        Từ tháng,năm <b><font color="red">*</font></b>
                                         <input value="<?php echo $thangluong;?>" name="thangluong" type="number" placeholder="00" required id="thangluong" style="width: 40px;padding-bottom:5px"> <input value="<?php echo $namluong;?>" name="namluong" type="number" placeholder="0000" required id="namluong" style="width: 70px;padding-bottom:5px">
                                    Vượt khung <input  name="vuotkhung" type="text" id="vuotkhung" value="<?php echo $vuotkhung;?>" style="width: 50px;padding-bottom:5px">
                            ...
                            <fieldset>
                                ...
                                <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                    <tbody><tr>
                                        ...
                                        <td>
                                            <select name="DropDoiTuong" id="DropDoiTuong" type="text" style="height:23px;width:200px;">
	<option value="">-----Chọn----</option>
                                ...
                                <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                    <tbody><tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="luong" type="number" id="luong" value="<?php echo $luong;?>">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <input name="nguonkhac" type="number" id="nguonkhac" value="<?php echo $thunhapkhac;?>" /> 
  ...
  <?php
    ...
    ?>
        ...
        <input type="text" name="check" id="check" value="<?php echo $check_image; ?>" />
</body>
</html>
<script>
