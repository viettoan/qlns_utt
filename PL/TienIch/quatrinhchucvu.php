<?php
  ...
  require_once('quatrinhchucvu/functions.php');
  // require_once('quatrinhchucvu/control.php');
    ...
    <div class="art-content-layout-row">
      <div class="art-layout-cell art-content">
        <article class="art-post art-article">
          <div class="container">
            <h2 class="page-header">Quá trình thay đổi Chức vụ</h2>
            <?php 
              $action = isset($_GET['action']) ? $_GET['action'] : false;
              // $cb_id = isset($_GET['cb_id']) ? $_GET['cb_id'] : false;

              if($action == 'new') {
                require_once('quatrinhchucvu/new.php');
              } elseif ($action == 'edit') {
                require_once('quatrinhchucvu/edit.php');
              } else {
                require_once('quatrinhchucvu/index.php');
              }
            ?>
          </div>
        </article>
