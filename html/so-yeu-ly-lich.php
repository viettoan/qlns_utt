              ...
              <div class="art-content-layout">
                <div class="art-content-layout-row">
                  <div class="art-layout-cell layout-item-1" style="width: 50%" >
                    ...
                    <form action=""></form>
                      <legend><i><b>Thông tin cơ bản</b></i></legend>
                      <div style:="width:">
                          ...
                          <tbody>
                            <tr>
                              <td style="width: 33%; border-style: hidden">
                                <img width="118" height="102" alt="" class="art-lightbox" src="images/IMG_3894.jpg">
                                <br>
                                <p><a href="#" class="art-button">Tải ảnh</a></p>
                              </td>
                      ...
                      <div class="form-group">
                        <label for="noisinh" class="col-lg-3 control-label"><b>Nơi sinh (xã, huyện, tỉnh)</b></label>
                        <div class="col-lg-9">
                          <select class="form-control" id="nsxa">
                          ...
                          <select class="form-control" id="nshuyen">
                            <option>Hoằng Hóa
                            </option>
                            <option>2
                            </option>
                          ...
                          <select class="form-control" id="nstinh">
                            <option>Thanh Hóa
                            </option>
                            <option>2
                            </option>
                      ...
                      <!--Quê quán-->
                      <div class="form-group">
                        <label for="quequan" class="col-lg-3 control-label"><b>Quê quán (xã, huyện , tỉnh)</b></label>
                        <div class="col-lg-9">
                          <select class="form-control" id="nsxa">
                            <option select="">Hoằng Đạo
                            </option>
                      ...
                      <!--Nơi đăng ký-->
                      <div class="col-lg-9">
                        <label for="inputhk" class="control-label"><b>Nơi đăng ký hộ khẩu thường trú</b></label> &nbsp;&nbsp;&nbsp; <input type="text" style="width: 40%" id="inputdangky" placeholder="Số nhà, đường phố (xóm, thôn)"><br>
                        <br>
                        <div class="col-lg-9">
                          <select class="form-control" id="hkxa">
                            <option select="">Hoằng Đạo
                            </option>
                            <option>2
                            </option>
                          ...
                          <select class="form-control" id="hkhuyen">
                            <option>Hoằng Hóa
                            </option>
                            <option>2
                            </option>
                          ...
                          <select class="form-control" id="hktinh">
                            <option>Thanh Hóa
                            </option>
                            <option>2
                            </option>
                      ...
                      <!--Nơi ở hiện nay-->
                      <div class="col-lg-9">
                        <label for="inputnoio" class="control-label"><b>Nơi ở hiện nay</b></label> &nbsp;&nbsp;&nbsp; <input type="text" style="width: 60%" id="inputnoio" placeholder="Số nhà, đường phố (xóm, thôn)"><br>
                        <br>
                        <div class="col-lg-9">
                          <select class="form-control" id="noxa">
                            <option select="">Hoằng Đạo
                            </option>
                            <option>2
                            </option>
                          ...
                          <select class="form-control" id="nohuyen">
                            <option>Hoằng Hóa
                            </option>
                            <option>2
                            </option>
                          ...
                          <select class="form-control" id="notinh">
                            <option>Thanh Hóa
                            </option>
                            <option>2
                            </option>
                      ...
                      <!--Gia đình chính sách-->
                      <div class="col-lg-9">
                        <label for="inputchinhsach" class="control-label"><b>Con gia đình chính sách</b></label>
                  ...
                  <div class="art-layout-cell layout-item-1" style="width: 50%" >
                    ...
                    <p></p>
                    <fieldset style="border: 1px solid lightgray;">
                      <legend><i><b>Đặc điểm lịch sử bản thân</b></i></legend>
                      <br>
                      <!--Đi tù-->
                      <div style:="width:">
                        <label for="inputnhansu" class="control-label"><b>Kê khai phạm tội</b></label><br>
                        <div style:="width:">
                          <table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: hidden; border-color: initial; width: 100%">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 33%; border-style: hidden"><input type="text" style="width: 100%" id="inputkhaibao" placeholder="Nguyễn Ngọc A">
                                </td>
                                <td style="width: 34%; border-style: hidden"><input type="text" style="width: 100%" id="inputvde" placeholder="Tình báo">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                      ...
                      <!--Làm ở chế độ cũ-->
                      <div style:="width:">
                        <label for="inputnhansu" class="control-label"><b>Làm việc với chế độ cũ</b></label><br>
                        <div style:="width:">
                          <table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: hidden; border-color: initial;">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputcquan" placeholder="CIA">
                                </td>
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputdvi" placeholder="Đông Nam Á">
                                </td>
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputcvu" placeholder="Trưởng phòng">
                                </td>
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputdd" placeholder="Hà Nội">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                      ...
                      <div style:="width:">
                        <label for="inputnhansu" class="control-label"><b>Quan hệ với tổ chức nước ngoài</b></label><br>
                        <div style:="width:">
                          <table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: hidden; border-color: initial;">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputtruso" placeholder="Mỹ">
                                </td>
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputnhiemvu" placeholder="Giám đốc">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                      ...
                      <div style:="width:">
                        <label for="inputnhansu" class="control-label"><b>Thân nhân ở nước ngoài</b></label><br>
                        <div style:="width:">
                          <table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: hidden; border-color: initial;">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 30%; border-style: hidden"><input type="text" style="width: 100%" id="inputname" placeholder="Nguyễn Văn A">
                                </td>
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputcviec" placeholder="Tổng thống">
                                </td>
                                <td style="width: 30%; border-style: hidden"><input type="text" style="width: 100%" id="inputdiachi" placeholder="Mỹ">
                                </td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <div class="art-content-layout">
                <div class="art-content-layout-row">
                  <div class="art-layout-cell layout-item-1" style="width: 100%" >
                    ...
                    <p></p>
                    <fieldset style="border: 1px solid lightgray;">
                      <legend><i><b>Quan hệ gia đình</b></i></legend>
                      <!--Về bản thân-->
                      <div style:="width:">
                        <label for="inputnhansu" class="control-label"><b>Về bản thân: Cha, Mẹ, Vợ (hoặc chồng), các con, anh chị em ruột</b></label><br>
                        <div style:="width:">
                          <table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: hidden; border-color: initial; width: 100%;">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputname1" placeholder="Nguyễn Văn A">
                                </td>
                                <td style="width: 10%; border-style: hidden"><input type="text" style="width: 100%" id="inputnsinh" placeholder="1960">
                                </td>
                                <td style="width: 60%; border-style: hidden"><input type="text" style="width: 100%" id="inputinfo" placeholder="Thanh Hóa, làm ruộng, ...">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                      ...
                      <!--Về nhà vợ-->
                      <div style:="width:">
                        <label for="inputnhansu" class="control-label"><b>Về bên vợ (hoặc chồng): Cha, Mẹ, anh chị em ruột</b></label><br>
                        <div style:="width:">
                          <table style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: hidden; border-color: initial; width: 100%;">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 30%; border-style: hidden"><input type="text" style="width: 100%" id="inputname1v" placeholder="Nguyễn Văn A">
                                </td>
                                <td style="width: 20%; border-style: hidden"><input type="text" style="width: 100%" id="inputnsinhv" placeholder="1960">
                                </td>
                                <td style="width: 30%; border-style: hidden"><input type="text" style="width: 100%" id="inputinfov" placeholder="Thanh Hóa, làm ruộng, ...">
                                </td>
                              </tr>
                            </tbody>
                          </table>
